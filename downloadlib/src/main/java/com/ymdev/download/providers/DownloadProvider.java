...
public final class DownloadProvider extends ContentProvider {
    ...
    private static List<Uri> BASE_URIS = new ArrayList();
    ...
    public static void setup(Context context){
        synchronized (sURIMatcher){
            ...
            sURIMatcher.addURI(Downloads.AUTHORITY, "download", MY_DOWNLOADS);
            sURIMatcher.addURI(Downloads.AUTHORITY, "download/#", MY_DOWNLOADS_ID);
            sURIMatcher.addURI(Downloads.AUTHORITY,
                    "download/#/" + Downloads.Impl.RequestHeaders.URI_SEGMENT,
                    REQUEST_HEADERS_URI);

            Downloads.Impl.CONTENT_URI = Uri.parse("content://"+Downloads.AUTHORITY+"/my_downloads");
            Downloads.Impl.ALL_DOWNLOADS_CONTENT_URI = Uri.parse("content://" +  Downloads.AUTHORITY + "/all_downloads");

            Downloads.CONTENT_URI =
                    Uri.parse("content://"+Downloads.AUTHORITY+"/my_downloads");
